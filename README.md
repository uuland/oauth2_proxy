...
2.  [Select a Provider and Register an OAuth Application with a Provider](docs/2_auth.md)
3.  [Configure OAuth2 Proxy using config file, command line options, or environment variables](docs/3_configuration.md)
4.  [Configure SSL or Deploy behind a SSL endpoint](docs/4_tls.md) (example provided for Nginx)
